 ...
 *
 * @see \Drupal\wembassy\Annotation\GrapeJSComponent
 * @see \Drupal\wembassy\GrapeJSComponentInterface
 * @see plugin_api
 */
class GrapesJSComponentManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      ...
      $namespaces,
      $module_handler,
      'Drupal\wembassy\Plugin\GrapesJS\Component\GrapesJSComponentInterface',
      'Drupal\wembassy\Annotation\GrapesJSComponent'
    );
