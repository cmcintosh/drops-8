 ...
 *
 * @see \Drupal\wembassy\Annotation\GrapeJSBlock
 * @see \Drupal\wembassy\GrapeJSBlockInterface
 * @see plugin_api
 */
class GrapesJSPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      ...
      $namespaces,
      $module_handler,
      'Drupal\wembassy\Plugin\GrapesJS\Plugin\GrapesJSPluginInterface',
      'Drupal\wembassy\Annotation\GrapesJSPlugin'
    );
