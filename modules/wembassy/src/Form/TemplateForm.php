...
class TemplateForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['#attached']['library'][] = 'wembassy/wembassy_backend_layout';
    ...
    $form['#theme'] = 'wembassy_backend_template';
  ...
  */
  private function addBreakpoints(&$form, $form_state) {
    ...
    $form['#attached']['drupalSettings']['wembassy']['breakpoints'] = [];
    foreach($entities as $id => $breakpoint) {
      $form['#attached']['drupalSettings']['wembassy']['breakpoints'][$id] = [
  ...
  */
  private function addFonts(&$form, $form_state) {
    ...
    $form['#attached']['drupalSettings']['wembassy']['fonts'] = [];
    foreach($entities as $id => $font) {
      $form['#attached']['drupalSettings']['wembassy']['fonts'][$id] = [
        'id' => $font->id(),
      ];
    }
  }
  ...
  */
  private function addColors(&$form, $form_state) {
    ...
    $form['#attached']['drupalSettings']['wembassy']['colors'] = [];
    foreach($entities as $id => $color) {
      $form['#attached']['drupalSettings']['wembassy']['colors'][$id] = [
        'id' => $color->id(),
        'name' => $color->get('name'),
  ...
  */
  private function addBuilder(&$form, $form_state) {
    $form['#attached']['drupalSettings']['wembassy']['builder']['fields'] = [];
    $form['#attached']['drupalSettings']['wembassy']['builder']['replaceFields'] = [];
    $form['#attached']['drupalSettings']['wembassy']['builder']['actionButtons'] = [];
    $form['#attached']['drupalSettings']['wembassy']['builder']['componentTemplates'] = [];
    $form['#attached']['drupalSettings']['wembassy']['builder']['typeUserDisabledAttrs'] = [];
    $form['#attached']['drupalSettings']['wembassy']['builder']['typeUserAttrs'] = [];
    $form['#attached']['drupalSettings']['wembassy']['builder']['disabledAttrs'] = [];
  }
