...
use Drupal\wembassy\Entity\Breakpoint;
...
class BreakpointAdminManageForm extends FormBase {
  ...
  */
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#attached']['library'][] = 'wembassy/font-awesome';
    $form['#attached']['library'][] = 'wembassy/ruler';
    $form['#attached']['library'][] = 'wembassy/wembassy_breakpoints';
    ...
    foreach($entities as $breakpoint) {
      $form['breakpoints'][] = [
        '#theme' => 'wembassy_breakpoint_form',
        'original_id' => [
          '#type' => 'value',
